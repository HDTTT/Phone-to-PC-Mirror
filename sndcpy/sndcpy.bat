...
if not defined VLC set VLC="D:\SmallTool\phone_share_to_PC\VLC\vlc.exe"
if not defined SNDCPY_APK set SNDCPY_APK=D:\SmallTool\phone_share_to_PC\sndcpy\sndcpy.apk
